"""Configuration management for Financial DeepResearch."""
...
class VectorDBConfig(BaseSettings):
    path: str = "./financial_agent/data/vector_db"
    collection_name: str = "financial_reports"
    distance_fn: Literal["cosine", "l2", "ip"] = "cosine"


class BM25Config(BaseSettings):
    index_path: str = "./financial_agent/data/bm25_index"
    k1: float = 1.5
    b: float = 0.75
...
class OutputConfig(BaseSettings):
    ...
    output_dir: str = "./financial_agent/data/output"
