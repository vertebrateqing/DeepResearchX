...
VALID_ROLES = {"tavily_search", "data_fetch", "doc_analysis", "cross_verify", "synthesis"}
...
2. role 只能从以下选择：[tavily_search, data_fetch, doc_analysis, cross_verify, synthesis]
