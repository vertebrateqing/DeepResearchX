...
3. suggested_tools 从 [tavily_search, data_fetch, web_scraper] 中选择
  ...
  "chapters": [
    {
      ...
      "suggested_tools": ["tavily_search", "data_fetch", "web_scraper"],
      "word_count": 800,
...
请直接输出JSON格式的报告大纲。"""
    ...
    def _parse_outline(self, content: str) -> ReportOutline | None:
        ...
        for c_data in data.get("chapters", []):
            ...
            valid_tools = {"tavily_search", "data_fetch", "web_scraper"}
        ...
        return ReportOutline(
            ...
            chapters=[
                ChapterOutline(
                    ...
                    suggested_tools=["tavily_search", "data_fetch"],
                    word_count=600,
