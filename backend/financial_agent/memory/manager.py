...
from financial_agent.memory.long_term_store import LongTermStore
...
class MemoryManager:
    ...
    Usage pattern:
        ...
        # Record task
        mm.start_task("financial_analysis", agent="rag_agent", inputs={"company": "茅台"})

        # Record finding
        mm.add_finding(
            source="akshare",
            content="贵州茅台2023年营收1505亿",
            related_entities=["贵州茅台", "600519"],
        )
