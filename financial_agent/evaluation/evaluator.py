...
from financial_agent.evaluation.llm_judge import LLMJudge
from financial_agent.evaluation.metrics import MetricsCalculator
...
class AgentEvaluator:
    ...
    async def evaluate_rag(
        ...
        Returns:
            Retrieval metrics
        """
        from financial_agent.rag.pipeline import RAGPipeline
